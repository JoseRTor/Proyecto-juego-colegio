...
export class GameTres extends Phaser.Scene {
  constructor() {
    super({ key: "gameTres" });
  }
  ...
  preload() {
    this.load.image("gameTresbackground", "../imagenes/mundo3.png");
    ...
    this.load.audio("themeSongLevelThree", "../audio/themeSongLevelThree.mp3");
  ...
  addMeteorito() {
    ...
    meteorito.speed = Phaser.Math.Between(4, 8);
  ...
  showCongratulations() {
    this.music.stop();
    this.scene.start("congratulationsDos", { nextScene: "gameFinal" });
  }
}
